...
public class SearchSpotsQueryHandler : IQueryHandler<SearchSpotsQuery, Result<SpotDto[]>>
{
    ...
    public ValueTask<Result<SpotDto[]>> Handle(SearchSpotsQuery query, CancellationToken cancellationToken)
    {
